# 33-meet-the-experts-behind-your-transformation

**Zone:** content  ·  **Rendered height:** 909px @1440  ·  **Appears on 1 page(s)**

## Content

- `<h3>` OUR TEAM
- `<h2>` Meet the experts behind your transformation
- `<h3>` Dr. Neha Verma
- `<h3>` Dr. Cameron Williamson
- `<h3>` Dr. Ayesha Kapoor
- `<h3>` Dr. Rahul Mehta
...
|---|---|---|---|---|---|---|
| 1 | 1300px | 909px | flex | — | 100px 0px 100px 0px | rgba(0, 0, 0, 0) |

## Widgets

| widget | n | rebuild note |
|---|---|---|
| `elementskit-image-box` | 4 | — |
| `elementskit-social-media` | 4 | — |
