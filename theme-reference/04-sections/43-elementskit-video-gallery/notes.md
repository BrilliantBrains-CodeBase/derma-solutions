# 43-elementskit-video-gallery

**Zone:** content  ·  **Rendered height:** 1310px @1440  ·  **Appears on 1 page(s)**
...
|---|---|---|---|---|---|---|
| 1 | 1300px | 1310px | flex | — | 100px 0px 100px 0px | rgba(0, 0, 0, 0) |

## Widgets

| widget | n | rebuild note |
|---|---|---|
| `elementskit-video-gallery` | 1 | — |
