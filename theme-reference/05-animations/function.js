(function ($) {
	...
	$window.on("elementor/frontend/init", function () {
		elementorFrontend.hooks.addAction("frontend/element_ready/glowix-casestudy-grid.default", casestudy_grid);
	});
	

	/* Service Item List Start */
	var $service_item_list = $('.service-item-list-gbc');
	if ($service_item_list.length) {
		var $service_item = $service_item_list.find('.service-item-gbc');
	...
	var $why_choose_list = $('.what-we-do-list-gbc');
	if ($why_choose_list.length) {
		var $why_choose_item = $why_choose_list.find('.what-we-do-item-gbc');
