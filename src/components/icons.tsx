...
/**
 * The mobile action bar's WhatsApp target. Deliberately NOT added to
 * `socialIcons` below — that map is keyed off site.ts `socialProfiles`, which
 * has no WhatsApp entry, and WhatsApp here is a contact channel, not a profile.
 */
...
/**
 * The action bar's Book circle. Stroked, not filled: it sits reversed-out in
 * white on the accent circle, where CheckSquareIcon's solid 16x16 body would
 * read as a white block rather than an icon.
 */
export function CalendarCheckIcon({ className }: IconProps) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <rect x="1.25" y="2.75" width="13.5" height="12" rx="2" />
      <path d="M1.25 6.25h13.5M4.75 1.25v3M11.25 1.25v3M5.25 10.15l1.85 1.85 3.65-3.65" />
    </svg>
  )
}
...
/**
 * The sidebar's opening-hours mark: a clock face with a "24" badge. Paths lifted
 * verbatim from the reference's icon-open-hour.svg
 * (06-assets/icons/2025-04-icon-open-hour.svg), with their hard-coded fills
 * dropped so the icon follows the card's white text. It keeps the reference's
 * 40x41 grid for the same reason the How It Works pictograms keep theirs.
 */
export function OpenHoursIcon({ className }: IconProps) {
  return (
    <svg {...base} className={className} viewBox="0 0 40 41" fill="currentColor">
      <path d="M20.0344 33.887C19.5014 33.8688 19.0664 34.2927 19.0664 34.8203V36.7638C19.6853 36.7992 20.3157 36.7992 20.9341 36.7638V34.8574C20.9341 34.3397 20.5305 33.9044 20.0344 33.887Z" />
      <path d="M32.2436 25.3782C28.0098 25.3782 24.5654 28.8226 24.5654 33.0564C24.5654 37.2902 28.0099 40.7346 32.2436 40.7346C36.4774 40.7346 39.9218 37.2901 39.9218 33.0564C39.9218 28.8225 36.4774 25.3782 32.2436 25.3782ZM31.1116 36.7917H27.1501C26.8983 36.7917 26.6713 36.64 26.575 36.4074C26.4786 36.1747 26.5318 35.907 26.7099 35.7289L29.5871 32.8516C29.9679 32.4708 29.9936 31.8505 29.6456 31.4394C29.202 30.9154 28.382 30.9548 27.991 31.5202L27.6622 31.9957C27.4667 32.2784 27.079 32.3493 26.7961 32.1536C26.5132 31.958 26.4425 31.5703 26.6381 31.2875L26.967 30.8118C27.8239 29.5729 29.6219 29.4846 30.596 30.6348C31.3593 31.5364 31.3029 32.8968 30.4676 33.7321L28.6531 35.5465H31.1116C31.4554 35.5465 31.7342 35.8252 31.7342 36.1691C31.7342 36.513 31.4554 36.7917 31.1116 36.7917ZM37.9597 34.3015C37.9597 34.6453 37.6811 34.924 37.3371 34.924H36.7146V36.1692C36.7146 36.513 36.4359 36.7918 36.092 36.7918C35.7481 36.7918 35.4694 36.5131 35.4694 36.1692V34.924H32.3619C32.1189 34.924 31.8981 34.7826 31.7964 34.5618C31.6948 34.3411 31.731 34.0813 31.8889 33.8966L35.619 29.5387C35.7886 29.3408 36.0633 29.2693 36.3079 29.3596C36.5523 29.4499 36.7146 29.6829 36.7146 29.9436V33.679H37.3372C37.6811 33.679 37.9597 33.9576 37.9597 34.3015Z" />
      <path d="M9.43496 30.0572L8.04004 31.452C8.45371 31.9175 8.89457 32.3586 9.36059 32.7727L10.7554 31.3778C11.1207 31.0125 11.1208 30.4226 10.7555 30.0572C10.3903 29.692 9.80027 29.6918 9.43496 30.0572Z" />
      <path d="M26.8478 21.4353C27.1946 21.4353 27.4704 21.1518 27.4704 20.8128C27.4704 20.4695 27.1911 20.1902 26.8478 20.1902H23.0498C23.1332 20.5997 23.1334 21.0249 23.0498 21.4353H26.8478Z" />
      <path d="M35.47 33.6789V31.6282L33.7148 33.6789H35.47Z" />
      <path d="M20.0005 18.9451C18.9706 18.9451 18.1328 19.783 18.1328 20.8127C18.1328 21.8426 18.9707 22.6804 20.0005 22.6804C21.0303 22.6804 21.8681 21.8425 21.8681 20.8127C21.8681 19.7829 21.0303 18.9451 20.0005 18.9451Z" />
      <path d="M5.99289 19.8789H4.04945C4.03156 20.188 4.02148 20.4992 4.02148 20.8127C4.02148 21.1263 4.03141 21.4374 4.04898 21.7466H5.99297C6.50789 21.7466 6.9268 21.3277 6.9268 20.8127C6.92672 20.2978 6.50781 19.8789 5.99289 19.8789Z" />
      <path d="M19.377 12.0969V17.7626C19.7865 17.6791 20.2117 17.679 20.6221 17.7626V12.0969C20.6221 11.7501 20.3386 11.4744 19.9995 11.4744C19.6562 11.4744 19.377 11.7536 19.377 12.0969Z" />
      <path d="M10.7559 10.2477L9.38703 8.87891C8.92172 9.2932 8.4807 9.73422 8.06641 10.1996L9.43516 11.5683C9.80039 11.9335 10.3904 11.9337 10.7558 11.5684C11.1211 11.203 11.1212 10.613 10.7559 10.2477Z" />
      <path d="M35.9516 21.7466C35.9873 21.1275 35.9873 20.4986 35.9516 19.8789H34.0451C33.5275 19.8789 33.0921 20.2825 33.0748 20.7786C33.0563 21.3118 33.4809 21.7466 34.0081 21.7466H35.9516Z" />
      <path d="M30.5652 11.5683L31.9602 10.1733C31.546 9.70731 31.1049 9.26646 30.6395 8.85278L29.2447 10.2475C28.8795 10.6128 28.8793 11.2028 29.2446 11.5682C29.6099 11.9335 30.1999 11.9336 30.5652 11.5683Z" />
      <path d="M20.0001 0.890869C14.6922 0.890869 9.69305 2.96681 5.92352 6.73626C2.15406 10.5058 0.078125 15.5049 0.078125 20.8128C0.0782031 31.7977 9.01508 40.7346 20 40.7346H20.0157C20.5218 40.7342 20.9338 40.317 20.9338 39.8046V38.0111C11.0936 38.5531 2.77586 30.7041 2.77586 20.8127C2.77586 11.3304 10.4915 3.5886 20 3.5886C29.8561 3.5886 37.7359 11.8634 37.198 21.7466H38.9918C39.5043 21.7466 39.9214 21.3345 39.9218 20.828V20.8127C39.9219 9.82782 30.985 0.890947 20.0001 0.890869Z" />
      <path d="M20.9341 6.80517V4.86118C20.2829 4.82431 19.7053 4.8247 19.0664 4.86173V6.80517C19.0664 7.32009 19.4853 7.739 20.0002 7.739C20.5152 7.739 20.9341 7.32009 20.9341 6.80517Z" />
    </svg>
  )
}
